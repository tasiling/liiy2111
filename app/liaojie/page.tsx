...
// 該頁籤的模擬新增按鈕;「噗浪蓋樓」頁籤(tabLinks 索引 5,2026-08-02 新增)同樣是
// 真實功能(/plurk,蓋樓台);其餘頁籤(今日工作/五光行旅/共振會/服務)仍是雛形
// 模擬內容。
export default function LiaojiePage() {
  return (
    <ModuleDomainPage
      ...
      tabs={["今日工作", "日上三更", "五光行旅", "共振會", "服務", "噗浪蓋樓"]}
      items={[
        "待審核內容預覽",
        "選題 → 生成 → 人工審核 → 發布",
        "靜水亭:光站 03",
      ...
      actions={["留下工作脈絡", "建立內容草稿", "新增／整理光站", "建立活動", "新增服務紀錄", "開始蓋樓"]}
      space="liaojie"
      tabLinks={[null, "/sanko", null, null, null, "/plurk"]}
      extra={
